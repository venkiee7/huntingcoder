    ...
    <div className={styles.container}>
      ...
      <main className={`${styles.main} ${inter.className}`}>
        ...
        {/* <p className={styles.description}>
          ...
          amet consectetur adipisicing elit. Quas nihil culpa sapiente
          reiciendis nostrum voluptatem suscipit, commodi harum, possimus
          quisquam dolores sit excepturi. */}
        {/* <p>
            Hunting Coders&nbsp;
        ...
        <div className="blogs">
          ...
          <div className={styles.blogItem}>
            ...
            <p className={styles.p}>
              Javascript language is used to design language for web
            </p>
